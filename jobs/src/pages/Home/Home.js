  ...
  return (
    <div className="home">
      ...
      <Container maxWidth="lg" className="main-content text-center">
        <Typography variant="h2" className="main-title my-4" style={{ fontWeight: 'bold' }}>
          이제, AI로 모의 면접을 시작하세요
        </Typography>
        <Typography variant="body1" className="main-description mb-4" style={{ fontWeight: 'bold', fontSize: '22px', marginBottom: '10px' }}>
        ...
        <Grid container spacing={4} className="mt-5">
          <Grid item xs={12} md={4}>
            <Box className="scroll-section p-3 shadow">
              <Typography variant="h5" className="scroll-title" style={{ fontWeight: 'bold', fontSize: '25px' }}>
                자기소개서를 분석합니다
              </Typography>
              <Typography variant="body2" style={{ marginTop: '15px', fontSize: '18px' }}>
